    ...
    <section class="content-header">
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href='/master/jenis'>Home</a></li>
                <li class="breadcrumb-item active">Master Jenis</li>
            </ol>
            </div>
        </div>
        </div><!-- /.container-fluid -->
...
<div class="modal fade" id="delete_data">
    ...
    <form autocomplete="off" id="validate" action="{{route('jenis.delete')}}" method="GET">
        @method('PATCH')
        @csrf
...
<div class="modal fade" id="create_data" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form autocomplete="off" id="validate" action="{{route('jenis.store')}}" method="POST"><!-- jika showEditModal = true maka edit, jika false maka create -->
            {{-- {{@csrf_field()}} --}}
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <label for="jenis" class="col-sm-2 col-form-label">Jenis Product</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="jenis" name="jenis" placeholder="Input jenis product" required>
                        </div>
                    </div>  
...
<div class="modal fade" id="edit_data" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form autocomplete="off" id="validate" action="{{route('jenis.update','test')}}" method="POST">
            {{-- @method('PATCH') --}}
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <label for="jenis" class="col-sm-2 col-form-label">Jenis Product</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="jenis" name="jenis" placeholder="Input jenis product" value="" required>
                        </div>
                    </div>  
