<form action="{{route('transaksi_admintransaksi.store')}}" method="POST">
  @csrf
  <div> 
        ...
        <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="modal-footer">
                <a href="{{route('transaksi_admintransaksi.index')}}" class="btn btn-danger"><i class="fa fa-times mr-1"></i> Cancel</a></li></a>
