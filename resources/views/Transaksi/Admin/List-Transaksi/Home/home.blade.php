                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if ($data->status_transaksi == "Sudah dibayar")<a href="{{route('transaksi_admintransaksi.create',$data->id_sewa)}}"><span class="badge bg-success">{{ $data->status_transaksi }}</span></a>@endif
                            @if ($data->status_transaksi == "disewa")<span class="badge bg-primary">{{ $data->status_transaksi }}</span>@endif
                        ...
                        <td>     
                          ...
                          @if ($data->status_transaksi != "Belum dibayar" && $data->status_transaksi != "Cancel")
...
<div class="modal fade" id="delete_data">
    ...
    <form autocomplete="off" id="validate" action="{{route('transaksi_admintransaksi.delete')}}" method="GET">
        @method('PATCH')
        @csrf
