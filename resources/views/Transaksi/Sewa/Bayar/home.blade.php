<form action="{{route('transaksi_sewa.save')}}" method="POST">
  @csrf
  <div> 
        ...
        <div class="row">
            ...
            <div class="col-md-6">
              <div class="card-body">
                ...
                <div class="row mb-2">
                  <label for="id_bank" class="col-sm-3 col-form-label">Bank</label>
                  <div class="col-sm-9">
                    <select name="id_bank" id="id_bank" class="form-control id_bank" required>
                      <option value="">--Pilih Bank--</option>
                      @foreach ($master_banks as $data)
                          <option value="{{$data->id}}">{{$data->nama_bank}} {{$data->nomor_rekening}} {{$data->atas_nama}}</option>
                      @endforeach
                    </select>
                  </div>
                </div>                            
              ...
              <div class="modal-footer">
                <a href="{{route('transaksi_sewa.index')}}" class="btn btn-danger"><i class="fa fa-times mr-1"></i> Cancel</a></li></a>
