                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $data->nomor_sewa }}
                            <br>
                            @if ($data->status_transaksi == "Belum dibayar")<a href="{{route('transaksi_sewa.bayar',$data->id_sewa)}}"><span class="badge bg-warning">{{ $data->status_transaksi }}</span></a>@endif
...
<div class="modal fade" id="delete_data">
    ...
    <form autocomplete="off" id="validate" action="{{route('transaksi_sewa.delete')}}" method="GET">
        @method('PATCH')
        @csrf
